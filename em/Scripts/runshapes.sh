...
declare -a arr=('ePt_Per_e_m_Mass' 'mPt_Per_e_m_Mass' 'emEta' 'DeltaR_e_m' 'm_met_mT_Per_e_m_Mass' 'e_met_mT_Per_e_m_Mass' 'MetEt' 'j1Pt' 'j1Eta' 'DeltaR_em_j1' 'j2Pt' 'j2Eta' 'DeltaR_em_j2' 'R_pT')
for i in "${arr[@]}"
do
  echo $i
  python shapesInputs.py --i $i
done
