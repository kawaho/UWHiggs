...
#    infoMap["ZTT"] = [["ZTauTau"+shift],"Z#rightarrow#tau#tau", "f", "#ffcc66"]
    ...
    if channel=="em" or channel=="et":
       infoMap["H125"] = [["LFVGG125"+shift, "LFVVBF125"+shift], "H#rightarrowe#mu (B=%.1f%%)"%higgsSF, "l", "#111bbb"]
    elif channel=="me" or channel=="mt":
       infoMap["H125"] = [["LFVGG125"+shift, "LFVVBF125"+shift], "H#rightarrow#mu#tau (B=%.1f%%)"%higgsSF, "l", "#111bbb"]
    return infoMap
