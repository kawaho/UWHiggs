...
varnames['DeltaPhi_em_j2'] = '#Delta#phi[e#mu, j_{2}]'
varnames['DeltaEta_e_m'] = '#Delta#eta[e, #mu]'
varnames['DeltaPhi_e_m'] = '#Delta#phi[e, #mu]'
...
h1.GetXaxis().SetTitleOffset(1.04) #1.04
