...
for j in Lists.procs:
    ...
    for h in Lists.bdthisto:
        plotter.plot_mc_vs_data('', ['VBF_LFV_HToEMu_M125*', 'GluGlu_LFV_HToEMu_M125*'], h[0], 4, xaxis = h[1], leftside=False, xrange=None, preprocess=None, show_ratio=True, ratio_range=2, sort=True, blind_region=False, control=s1, jets=j, year='2018', channel='emu')
        plotter.save(h[0]+j)
