...
legend.AddEntry("MMVA1","-1 < BDT < -0.183","l");
legend.AddEntry("MMVA2","-0.183 < BDT < -0.093","l");
legend.AddEntry("MMVA3","-0.093 < BDT < -0.014","l");
legend.AddEntry("MMVA4","-0.014 < BDT < 0.058","l");
legend.AddEntry("MMVA5","0.058 < BDT < 1","l");
