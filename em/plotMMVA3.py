...
legend.AddEntry("MMVA1","-1 < BDT < -0.194","l");
legend.AddEntry("MMVA2","-0.194 < BDT < -0.103","l");
legend.AddEntry("MMVA3","-0.103 < BDT < -0.023","l");
legend.AddEntry("MMVA4","-0.023 < BDT < 0.053","l");
legend.AddEntry("MMVA5","0.053 < BDT < 1","l");
