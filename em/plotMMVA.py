from ROOT import TH1, TH2F, TFile, TCanvas, gStyle, TLegend, TLine, gPad, TLatex, TProfile
from Kinematics import functor_gg
import array 

def var_d_gg(tree):
  return {'DeltaPhi_e_m': tree.DeltaPhi_e_m, 'DeltaEta_e_m': tree.DeltaEta_e_m, 'mEta':tree.mEta, 'eEta': tree.eEta, 'm_met_mT': tree.m_met_mT,'e_met_mT': tree.e_met_mT, 'emEta': tree.emEta, 'DeltaEta_m_met': tree.DeltaEta_m_met, 'DeltaEta_e_met': tree.DeltaEta_e_met, 'MetEt': tree.MetEt, 'DeltaPhi_e_met': tree.DeltaPhi_e_met, 'emPt': tree.emPt, 'DeltaPhi_em_j1': tree.DeltaPhi_em_j1, 'ePt_Per_e_m_Mass': tree.ePt_Per_e_m_Mass , 'mPt_Per_e_m_Mass': tree.mPt_Per_e_m_Mass,'j1Pt': tree.j1Pt, 'DeltaEta_em_j1': tree.DeltaEta_em_j1, 'e_m_PZeta': tree.e_m_PZeta, 'DeltaPhi_m_met': tree.DeltaPhi_m_met} 
...
MMVAP = TProfile('MMVAp', ' ', 50, 110, 160, -1, 1)
...
for i in range(0, nEntries2):
  ...
  if  not (oldtree2.Nj==2 and oldtree2.j1_j2_mass>400 and oldtree2.DeltaEta_j1_j2>2.5):
    ...
    MMVAP.Fill(oldtree2.e_m_Mass, mva, oldtree2.weight)
...
MMVAP.SetYTitle("Profile of BDT Discriminator")
MMVAP.SetXTitle("m_{e#mu} (GeV)")
