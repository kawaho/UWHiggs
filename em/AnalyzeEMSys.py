...
class AnalyzeEMSys(MegaBase, EMBase):
  ...
  def fill_sys(self, row, myEle, myMuon, myMET, myJet1, myJet2, njets, mjj, e_m_PZeta, weight):    
    ...
    if self.is_mc:
      ...
      if puweight==0:
        self.fill_categories(myEle, myMuon, myMET, myJet1, myJet2, njets, mjj, row.e_m_PZeta, 0, '/puUp2018')
        self.fill_categories(myEle, myMuon, myMET, myJet1, myJet2, njets, mjj, row.e_m_PZeta, 0, '/puDown2018')
      else:
        self.fill_categories(myEle, myMuon, myMET, myJet1, myJet2, njets, mjj, row.e_m_PZeta, weight*puweightUp/puweight, '/puUp2018')
        self.fill_categories(myEle, myMuon, myMET, myJet1, myJet2, njets, mjj, row.e_m_PZeta, weight*puweightDown/puweight, '/puDown2018')
      ...
      if nbtag > 0:
        ...
        self.fill_categories(myEle, myMuon, myMET, myJet1, myJet2, njets, mjj, row.e_m_PZeta, weight*btagweightup/btagweight, '/bTagUp2018')
        self.fill_categories(myEle, myMuon, myMET, myJet1, myJet2, njets, mjj, row.e_m_PZeta, weight*btagweightdown/btagweight, '/bTagDown2018')
      ...
      if not (self.is_recoilC and self.MetCorrection):
        for u in self.ues:
          ...
          self.fill_categories(myEle, myMuon, tmpMET, myJet1, myJet2, njets, mjj, row.e_m_PZeta, weight, '/'+u+"2018")
        ...
        for j in self.jes:
          ...
          if 'year' in j or 'RelativeSample' in j or 'JER' in j:  
            self.fill_categories(myEle, myMuon, tmpMET, tmpJet1, tmpJet2, tmpnjets, tmpmjj, row.e_m_PZeta, weight, '/'+j+"2018")
