...
#      histos[name+'/lhe'+str(i)+'_2017/e_m_GenVisibleMass'].Fill((genEle+genMuon).M(), weight*lheweight)
#      histos[name+'/lhe'+str(i)+'_2016/e_m_GenVisibleMass'].Fill((genEle+genMuon).M(), weight)
#      histos[name+'/lhe'+str(i)+'_2018/e_m_GenVisibleMass'].Fill((genEle+genMuon).M(), weight)
  ...
  def process(self):
    ...
    for row in self.tree:
      ...
      njets, mjj = row.jetVeto30WoNoisyJets, row.vbfMassWoNoisyJets
