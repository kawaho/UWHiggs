...
ww_file = ROOT.TFile("/afs/hep.wisc.edu/user/kaho/CMSSW_10_2_16_UL/src/UWHiggs/em/WW_weight.root")
ww_weight = ww_file.Get("WW_weight") 

cmsswBase = '/afs/hep.wisc.edu/home/kaho/CMSSW_10_2_16_UL/src/FinalStateAnalysis/TagAndProbe/data/2018/'
