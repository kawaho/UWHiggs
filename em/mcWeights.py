class mcWeights:
    def __init__(self, target):
        ...
        self.is_VV = bool(self.is_WW or self.is_WZ or self.is_ZZ)
    ...
    def lumiWeight(self, weight):
        ...
        if self.is_GluGlu:
            weight = weight*0.00067732 #0.00068074
        if self.is_VBF:
            weight = weight*0.00030513#0.00029536
        if self.is_WW:
