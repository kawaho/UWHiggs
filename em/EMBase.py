...
class EMBase():
  ...
  def __init__(self):
    self.ww_weight = mcCorrections.ww_weight
    ...
    self.is_WW = self.mcWeight.is_WW
...
#      self.book(n, 'emEta', 'Electron + Muon Eta', 120, -7, 7)
#      self.book(n, 'DeltaR_e_m', 'Delta R of Electron and Muon', 35, 0, 4.5)
#      self.book(n, 'm_met_mT_Per_e_m_Mass', 'Muon + MET Transverse Mass', 26, 0, 3.5)
#      self.book(n, 'e_met_mT_Per_e_m_Mass', 'Electron + MET Transverse Mass', 27, 0, 3.5)
#      self.book(n, 'MetEt', 'MET E_T', 300, 0, 400)
#      self.book(n, 'j1Pt', 'Leading Jet pT', 350, 0, 500)
#      self.book(n, 'j1Eta', 'j1Eta', 10, -5, 5)
#      self.book(n, 'DeltaR_em_j1', 'Delta R of Electron-Muon and leading Jet', 35, 0, 8)
#      self.book(n, 'j2Pt', 'Subleading Jet pT', 160, 0, 200)
#      self.book(n, 'j2Eta', 'j2Eta', 10, -5, 5)
#      self.book(n, 'DeltaR_em_j2', 'Delta R of Electron-Muon and sub-leading Jet', 35, 0, 7)
#      self.book(n, 'R_pT', 'pT Balance Ratio', 10, 0, 0.8)
...
#      self.book(n, 'DeltaEta_j1_j2', 'Delta Eta of Jets', 40, 0, 4.5)
...
#MG
#      eff_trg_data = self.w1.function('e_trg_23_data').getVal()*self.w1.function('m_trg_23_data').getVal()
#      eff_trg_mc = self.w1.function('e_trg_23_mc').getVal()*self.w1.function('m_trg_23_mc').getVal()
#      tEff = 0 if eff_trg_mc==0 else eff_trg_data/eff_trg_mc
      ...
      weight = weight*row.GenWeight*pucorrector[''](row.nTruePU)*tEff*eID*eIso*eReco*mID*mIso*mTrk

      #WW
      if self.is_WW: # and self.oppositesign(row):
        weight = weight * 0.8911
      if self.is_DY:
        # DY pT reweighting
