...
hmvaB = TH1F("mvaB", "Background MVA", 200, -1, 1)
...
print "Passing Background Rate: ", newtree2.GetEntries()/nEntries2
newtree2.Write()
hmvaB.Write()
#gr.Write()
...
print "Passing Signal Rate: ", newtree1.GetEntries()/nEntries1
newtree1.Write()
hmvaS.Write()
