...
class AnalyzeMMTDeep(MegaBase):
  ...
  def begin(self):
    names=['initial', 'loose', 'LDM0', 'LDM1', 'LDM10', 'LDM11', 'LEBDM0', 'LEBDM1', 'LEBDM10', 'LEDM11', 'LEEDM0', 'LEEDM1', 'LEEDM10', 'LEEDM11', 'tight', 'TDM0', 'TDM1', 'TDM10', 'TDM11', 'TEBDM0', 'TEBDM1', 'TEBDM10', 'TEBDM11', 'TEEDM0', 'TEEDM1', 'TEEDM10', 'TEEDM11']
    namesize = len(names)
    ...
    for row in self.tree:
      ...
      if self.tau_vloose(row):
        ...
        if row.tDecayMode == 0:
          ...
          self.fill_histos(row, myMuon1, myMuon2, myTau, weight, 'LDM11')
        if abs(row.tEta) < 1.5:
          if row.tDecayMode == 0:
            ...
            self.fill_histos(row, myMuon1, myMuon2, myTau, weight, 'LEDM11')
        else:
          if row.tDecayMode == 0:
      ...
      if self.tau_tight(row):
        ...
        if row.tDecayMode == 0:
          ...
          self.fill_histos(row, myMuon1, myMuon2, myTau, weight, 'TDM11')
