...
years = [cmsbase + 'UWHiggs2016/lhe2016/em/results/MCLHE2016_NEW/AnalyzeEMuCF/', cmsbase + 'UWHiggs2017/lhe/em/results/MCLHE/AnalyzeEMuCF/', 'results/MCLHE2018/AnalyzeEMuCF/']

result = open("bkgCF_EM.csv", "w")
